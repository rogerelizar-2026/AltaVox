...
export default class QuerySelector {
     ...
     * @returns HTML elements.
     */
    static querySelectorAll<E extends Element = Element>(node: Element | Document | DocumentFragment, selector: string): NodeList<E>;
    /**
     ...
     * @returns HTML element.
     */
    static querySelector<E extends Element = Element>(node: Element | Document | DocumentFragment, selector: string): E | null;
    /**
